...
const usageAnalyticsKeys = [
  ...
  'usage_analytics.heatmap_range_label',
  'usage_analytics.heatmap_coverage_label',
  'usage_analytics.heatmap_coverage_value',
  'usage_analytics.heatmap_bucket_label',
  'usage_analytics.heatmap_bucket_hint',
  'usage_analytics.heatmap_detail_title',
  'usage_analytics.heatmap_detail_hint',
  'usage_analytics.heatmap_detail_date_windows',
  'usage_analytics.heatmap_detail_date_more',
  'usage_analytics.heatmap_detail_date_empty',
